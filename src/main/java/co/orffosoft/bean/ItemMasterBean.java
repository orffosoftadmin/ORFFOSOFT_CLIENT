...
//			itemMasterDTO.setCreatedBy(userDto);
//			itemMasterDTO.setCreatedDate(new Date());
//			itemMasterDTO.setCode(itemMasterDTO.getCode().trim());
//			itemMasterDTO.setName(itemMasterDTO.getName().trim());
...
//			itemMasterDTO.setCode(itemMasterDTO.getCode().trim());
//			itemMasterDTO.setName(itemMasterDTO.getName().trim());
//			itemMasterDTO.setLname(itemMasterDTO.getLname().trim());
//
...
//		productVarietyMasterDTO = new ProductVarietyMasterDTO();
	...
	public String showEditForm() {
		...
		try {
			...
			itemMasterDTO.setId(productVarityMasterResponse.getVarityId());
			log.info("<<=====   selected Dto == " + itemMasterDTO.getId());
			getUOM();
			BaseDTO baseDTO = new BaseDTO();
...
//			productVarietyMasterDTO = mapper.readValue(jsonResponse, itemMasterDTO.class);
